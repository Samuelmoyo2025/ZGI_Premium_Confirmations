...
**If a search comes up empty**, Claims sees a clear "please contact Finance
for assistance" message — and it's automatically logged to the Audit Trail
(below) so Finance knows to follow up, without anyone needing to send an
email about it.
